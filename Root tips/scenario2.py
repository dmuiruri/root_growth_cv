...
# import functions 
from fileWITHfunctions import find_contours, processImage, draw_circles_around, add_Text, process_ML_image, extract_data_DF, compareTips
...
result_DF = pd.DataFrame(columns=['Root #ID', 'Tip lenght #1', '(x1,y1)', 'Radius #1', 'Tip length #2', '(x2,y2)', 'Radius #2','Difference, mm'])
...
result_DF.to_csv('2dayRESULT.csv', sep=';', index=False)

# # Save processed images
cv2.imwrite("2dayRESULT.png", im2_original)
