...
class SegNet(nn.Module):
    ...
    def __init__(self, width=8, depth=5, num_classes=2):
        ...
        # One pixel convolution -> image dimension to one
    ...
    def forward(self, x):
        ...
        # End convolution
        x = self.classifier(x)
        # Sigmoid. End values are between 0 and 1, so thershold results later.
        x = torch.sigmoid(x)
        return x

# Main is for testing purposes
if __name__ == '__main__':
    x = torch.randn((1, 3, 1600, 1600))
